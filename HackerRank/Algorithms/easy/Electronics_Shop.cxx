...
int getMoneySpent(vector<int> keyboards, vector<int> drives, int b) {
    ...
    if (keyboards.front() >= b || drives.front() >= b)
        return -1;
    int max_idx1 = std::distance(keyboards.begin(), std::lower_bound(keyboards.begin(), keyboards.end(), b));
    int max_idx2 = std::distance(drives.begin(), std::lower_bound(drives.begin(), drives.end(), b));
